 ...
 */
kvm_pfn_t hva_to_pfn(unsigned long addr, bool interruptible,
		     bool no_wait, bool write_fault, bool *writable)
{
	struct vm_area_struct *vma;
	kvm_pfn_t pfn;
	int npages, r;
...
{
	return __gfn_to_pfn_memslot(slot, gfn, true, false, false, true,
				    NULL, NULL);
}
